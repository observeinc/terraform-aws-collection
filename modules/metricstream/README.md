...
| <a name="input_verbosity"></a> [verbosity](#input\_verbosity) | Logging verbosity for the metrictag Lambda. Highest log verbosity is 9. Only used when enable\_tag\_enrichment is true. | `number` | `1` | no |
